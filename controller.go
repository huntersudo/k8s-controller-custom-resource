...
import (
	...
	samplecrdv1 "./pkg/apis/samplecrd/v1"
	clientset "./pkg/client/clientset/versioned"
	networkscheme "./pkg/client/clientset/versioned/scheme"
	informers "./pkg/client/informers/externalversions/samplecrd/v1"
	listers "./pkg/client/listers/samplecrd/v1"
)
